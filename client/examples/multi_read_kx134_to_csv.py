...
from accelmon import CsvSampleSink, IntervalSignedInt16Converter, NoConversionConverter
...
if __name__ == "__main__":
	...
	parser.add_argument('filename', 
			help='CSV file for data output, appended with port and timestamp')
	parser.add_argument('-b', '--bias', 
			help='Bias offsets for [x, y, z]. Note this does not increase the fundamental range of the accelerometer')
	parser.add_argument('-a', '--averging-period', 
	...
	csvRead = KXreadTo(args.filename, args.port)
